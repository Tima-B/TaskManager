...
class TaskManager(models.Manager):
    def get_queryset(self):
        ...
        # вычисление планируемой даты завершения
        qs = qs.annotate(
            date_plan=Case(
        ...
        # вычисление количества дней до планируемой даты завершения
        qs = qs.annotate(
            days_plan=Case(
        ...
        # вычисление минимальной возможной даты завершения задачи
...
class SprintManager(models.Manager):
    def get_queryset(self):
        ...
        # вычисление максимальной даты завершения спринта
        qs = qs.annotate(date_end_task=Max("sprint_tasks__date_end"))

        # вычисление минимальной возможной даты завершения спринта
        qs = qs.annotate(
...
class ProjManager(models.Manager):
    def get_queryset(self):
        ...
        # вычисление планируемой даты завершения проекта
        ...
        # вычисление максимальной даты завершения спринтов проекта
        qs = qs.annotate(date_end_sprint=Max("proj_sprints__date_end"))

        # вычисление максимальной даты завершения задач проекта
        qs = qs.annotate(date_end_task=Max("proj_tasks__date_end"))

        # вычисление минимальной возможной даты завершения проекта
        qs = qs.annotate(
            date_end_proj=Case(
