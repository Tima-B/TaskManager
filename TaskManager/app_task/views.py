...
def ProjTemplate(self: TemplateView, oper: str) -> View:
    ...
    match oper:
        case "list":
            ...
            # фильтр по статусу выполнения (завершено, нет, все)
            ...
            # фильтр по автору (автор или все)
...
def SprintTemplate(self: TemplateView, oper: str) -> View:
    ...
    match oper:
        case "list":
            ...
            # фильтр поиска статусу выполнения (завершено, нет, все)
            match par.get(url_filt, ""):
                case "on":
                    list_qs = list_qs.exclude(date_end=None)
                case "all":
...
def TaskTemplate(self: TemplateView, oper: str) -> View:
    ...
    match oper:
        case "list":
            ...
            # фильтр по автору или исполнителю (исполнитель, автор, всё)
